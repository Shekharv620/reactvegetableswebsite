...
export default class Phone extends Component {
    ...
    render() {
      ...
      <style>{'body { background-image:url("https://images.unsplash.com/photo-1467453678174-768ec283a940?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1028&q=80"); }'}</style>
                ...
                <h1  style={{fontSize:"100px"}} className="h1"><marquee width="60%" direction="left" height="100px"scrollamount="20">
<b>Phone Login</b></marquee></h1>
                 ...
                 <Form noValidate validated={this.state.validated} onSubmit={this.onSignInSubmit}> 
                    ...
                    <Button style={{fontSize:"30px",background:"teal"}} variant="primary" type="submit">
                        Login
                    </Button>
                </Form>
            </div>
